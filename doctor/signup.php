...
if($query -> rowCount() == 0)
{
$sql="Insert Into tbldoctor(FullName,Location,MobileNumber,Email,Specialization,Password)Values(:fname,:loc,:mobno,:email,:sid,:password)";
...
<head>
	...
	<title>GetDoc - SignUp Page</title>
...
<body style="background-color:green" class="simple-page">
	<div id="back-to-home">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">GetDoc</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInX" id="login-form">
			<h4 class="form-title m-b-xl text-center">Fill in you details</h4>
			...
			<div class="form-group">
				<input id="loc" type="text" class="form-control" placeholder="Full address" name="loc" required="true">
			</div>
			<div class="form-group">
