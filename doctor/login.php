...
<body class="simple-page" style="background-color:green">
	<div id="back-to-home">
	...
	<h4 class="form-title m-b-xl text-center">Sign In With Your GetDoc Account</h4>
