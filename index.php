    ...
    <body id="top">
        ...
        <main>
                            ...
                            <div id="myCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <div class="carousel-item active">
                                        <img src="images\slider\medical2.jpg" class="img-fluid" alt="">
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        <img src="images/slider/medical1.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
            ...
            <section class="section-padding" id="about">
                <div class="container">
                            <h2 class="mb-lg-3">About us</h2>
                            <p><div><font color=black face=\"arial, sans-serif\"><b>Welcome to GetDoc - Your Trusted Partner in Health Care! At GetDoc, we are committed to revolutionizing the way you access healthcare services. Our platform is designed to provide a seamless and convenient solution for managing your medical appointments, connecting with trusted healthcare professionals, and taking control of your health journey</b></font></div></p>
